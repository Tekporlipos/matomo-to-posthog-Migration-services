...
function smart_search_mapper(data) {
    return {
        event: (0, functions_1.capitalizeSentences)(data.category + ' - ' + (0, functions_1.formatActionForSmartSearch)(data.action)),
...
function getParameters(data) {
    ...
    if (data.action.includes("Upvoted") || data.action.includes("Reported") || data.action.includes("Viewed"))
